	...
	html! {
		<section>
			<div class="mdl-card__title">
				<h2 class="mdl-card__title_text">{"Translate Clip #1"}</h2>
			</div>
			<div class="mdl-card__supporting-text">
				<audio src=audio_url(&game.active_verb.search) ref=game.audio_ref.clone()/>
				{ recognition_answer_row(game.show_answer, link) }
				{
					if game.show_answer {
